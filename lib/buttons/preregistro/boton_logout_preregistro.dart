...
class BotonLogoutPreregistro extends StatelessWidget {
  final int usuarioId;

  const BotonLogoutPreregistro({super.key, required this.usuarioId});
    ...
    try {
      ...
      try {
        ...
        if (response.statusCode == 200 && data['success'] == true) {
          ...
          // ✅ Redirige correctamente a login de prerregistro
          Navigator.pushReplacementNamed(context, AppRoutes.preregistro);
        } else {
