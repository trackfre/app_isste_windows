...
class BotonLogoutAdmin extends StatelessWidget {
  final int usuarioId;

  const BotonLogoutAdmin({super.key, required this.usuarioId});
    ...
    try {
      ...
      try {
        ...
        if (response.statusCode == 200 && data['success'] == true) {
          ...
          // Redirige correctamente al login del administrador
          Navigator.pushReplacementNamed(context, AppRoutes.administrador);
        } else {
